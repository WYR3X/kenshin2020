...
const http = require('http');
    ...
    setInterval(() => {
    http.get(`http://kenshin2020.glitch.me/`);
    }, 280000);  
...
.setColor("RANDOM")
.addField(`Merhaba ${guild.name}`, "adlı sunucuya başarıyla katıldım.")
.addField("Komutlarımı Görmek İçin", "k!yardım")
.addField("Prefixim ", "k!")
.setFooter("Kenshin - Tüm Hakları Saklıdır.") 
.setTimestamp()
.setThumbnail("https://giffiles.alphacoders.com/148/148159.gif")

guild.owner.send(darkcode); 
