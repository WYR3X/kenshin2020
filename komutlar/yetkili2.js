...
exports.run = (client, message, params) => {
  ...
  .setTitle("**<a:kenshin_ayarlar:726155629248380998> Kenshin - Yetkili Kategorisi**")
    ...
    .addBlankField()
  .setColor('RANDOM')
  .addField("**<a:kenshin_kirmizi:726397765680234537> Sunucunuz için küfür engellemeyi açar/kapatır!**", `Örnek Kullanım = k!küfür-engel <aç/kapat>`)
  ...
  .addField("**<a:kenshin_kirmizi:726397765680234537> Belirttiğiniz kanaldaki bütün mesajları siler ve yeniden oluşturur!**", `Örnek Kullanım = k!nuke <#kanal>`)
  .addField("**<a:kenshin_aqua:726397835477647412> Sunucunuzdaki istediğiniz üyeyi belirttiğiniz süre boyunca susturur!**", `Örnek Kullanım = k!mute <@üye> <1sn/1dk/1s/1y>"`)
